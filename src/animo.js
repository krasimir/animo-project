animo = (function() {
    ...
    var ease = (function() {
        ...
        return {
            calculate: function(options) {     
                if(typeof options == "undefined"){ animo.error("missing options"); return; }            
                if(typeof options.start == "undefined"){ canimo.error("missing options.start"); return; }
                if(typeof options.end == "undefined"){ animo.error("missing options.end"); return; }
                if(typeof options.steps == "undefined"){ animo.error("missing options.steps"); return; }
                if(typeof options.method == "undefined"){ animo.error("missing options.method"); return; }                
                var values = [];
    ...
    var error = function(msg) {
        if(animo.mode == "production") {
            throw new Error("animo: " + msg);
        } else if(animo.mode == "development") {
